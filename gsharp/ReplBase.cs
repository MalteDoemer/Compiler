...
namespace Compiler
{
    public abstract class ReplBase
    {
        ...
        public static void ColorWrite<T>(T data, ConsoleColor fg = ConsoleColor.Gray, ConsoleColor bg = ConsoleColor.Black)
        {
        ...
        public static void ColorWriteLine<T>(T data, ConsoleColor fg = ConsoleColor.Gray, ConsoleColor bg = ConsoleColor.Black)
        {
            Console.ForegroundColor = fg;
