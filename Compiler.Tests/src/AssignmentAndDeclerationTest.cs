...
namespace Compiler.Test
{
    public class VariableTests
    {
        ...
        public void Variable_Has_Correct_Value(string text, string variable, object initialVal, object expected)
        {
            ...
            // var comp2 = Compilation.CompileScript(new SourceText(line2, null), Compilation.StandardReferencePaths, comp1);
            // var comp3 = Compilation.CompileScript(new SourceText(line3, null), Compilation.StandardReferencePaths, comp2);
