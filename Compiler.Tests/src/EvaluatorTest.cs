...
namespace Compiler.Test
{
    public class EvaluatorTest
    {
        ...
        // [InlineData("10 / 3.4", 2.9411764705882352941176470588235f)]
        ...
        // {
        //     text = $"def main() {{ print({text}) }}";
        //     var expected = value.ToString();
        //     var compilation = Compilation.Compile(new[] { new SourceText(text, null) }, Compilation.StandardReferencePaths);
