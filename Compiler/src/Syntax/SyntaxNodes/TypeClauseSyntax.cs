...
namespace Compiler.Syntax
{
    ...
    {
        public ArrayTypeSyntax(TypeSyntax underlyingType, SyntaxToken leftBracket, SyntaxToken rightBracket, bool isValid, TextLocation location) : base(isValid, location)
        {
